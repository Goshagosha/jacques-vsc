...
class IdProvider:  # pylint: disable=too-few-public-methods # it's a generator
...
class ListIndex:  # pylint: disable=too-few-public-methods # it's a dataclass
...
class _Argument(
    ...
    class Placeholder(ABC, AST):
        ...
        def __init__(
            self, id_factory: IdProvider, examples, placeholding_for: ast.AST
        ):
